...
public class ConeStackDepoDemo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StepRunner runner = StepRunner.getInstance(telemetry, drive);
        ...
        runner.parkFromJunction2(trajectoryGenerator.getParkLeft(), trajectoryGenerator.getParkCentre(), trajectoryGenerator.getParkRight(), zone);
