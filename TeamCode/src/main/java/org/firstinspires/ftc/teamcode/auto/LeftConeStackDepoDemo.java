...
public class LeftConeStackDepoDemo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryGenerator.getInstance().initialise(TrajectoryGenerator.Alliance.RED, TrajectoryGenerator.Side.LEFT, drive, slideSystem);
